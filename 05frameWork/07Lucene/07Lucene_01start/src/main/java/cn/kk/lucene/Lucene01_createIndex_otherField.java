...
public class Lucene01_createIndex_otherField {
    ...
    public static void createIndex() throws Exception{
       ...
       // RAMDirectory ramD = new RAMDirectory();
        //把索引库保存到磁盘
        FSDirectory directory = FSDirectory.open(new File("D:\\All_Study\\Java\\All_projects\\IdeaProjects\\05frameWork\\07Lucene\\lucene_index_otherField").toPath());
